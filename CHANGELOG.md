...
- **CI/CD Pipeline Integration**:
  - Added missing `test:ci` and `cli:build` scripts to `package.json` to resolve build failures in GitHub Actions.
  - Added `test:watch` script for improved developer experience.
  - Standardized CI test runner configuration across `publish.yml` and `ci.yml`.
